...
### Added
- Support for Schema 15 (Segment 15 - DAW999B1) parsing.
- `DaBottomHoleLocationRecord` model.
- Recurring segment support for '15' (GIS Data).
...
### Added
- Support for Schema 12 (Segment 12 - DAREMARK) parsing.
- `DaRemarkRecord` model.
- Recurring segment support for '12'.
...
### Added
- Support for Schema 09 (Segment 9 - DAFREFLD) parsing.
- `DaFreeRestrFieldRecord` model.
- Recurring segment support for '09'.

## [0.8.0] - 2025-12-10

### Added
- Support for Schema 08 (Segment 8 - DAFRERES) parsing.
- `DaFreeRestrRecord` model.
- Recurring segment support for '08'.
